...
mag_save_dir = r'E:\MAG\code_final_version\data\huawei_table_lab\new_digit\sensor\mag'

acc_dir = r'E:\MAG\code_final_version\data\huawei_table_lab\aligned\acc'
acc_save_dir = r'E:\MAG\code_final_version\data\huawei_table_lab\new_digit\sensor\acc'

gyr_dir = r'E:\MAG\code_final_version\data\huawei_table_lab\aligned\gyr'
gyr_save_dir = r'E:\MAG\code_final_version\data\huawei_table_lab\new_digit\sensor\gyr'

voice_dir = r'E:\MAG\code_final_version\data\huawei_table_lab\voice'
voice_save_dir = r'E:\MAG\code_final_version\data\huawei_table_lab\new_digit\voice'
    ...
    while voice_idx<len(voice):
        if np.abs(float(voice[voice_idx]))<0.0005:
            ...
            while voice_idx+1 < len(voice) and voice[voice_idx+1]<0.0005:
                cnt += 1
                voice_idx += 1
            if 40 * 96<cnt<48000*8:
                idxs.append((begin_voice_idx+voice_idx-1)//2)
            if cnt>48000*7:
